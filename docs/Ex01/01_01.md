...
1. In the leftmost pane, go to **Endpoints** > **Vulnerability Management** > **Dashboard**.

    ![qgnei092.jpg](../../media/qgnei092.jpg)

    {: .note }
    > Observe the **Exposure score** for the organization, which breaks it down by device impact, top software vulnerabilities, misconfigurations and exposed devices.
