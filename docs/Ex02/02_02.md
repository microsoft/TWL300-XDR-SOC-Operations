...
1. Right-click **threatpolicies** > **Run with PowerShell**, then authenticate with your global admin account.
    ...
    {: .note }
    > The script performs the following actions in your environment:  
    >
...
1. In the **Query** pane, run the following KQL:
    ...
    {: .note }
    > This simulates recent email URL click and detonation activity using generated data so you can toggle the **URL Clicks** and **Detonations** columns in the Explorer view to confirm signal visibility and column behavior.
