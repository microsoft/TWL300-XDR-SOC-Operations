...
1. In the dialog, select **Export PDF**, then select **Download**.
    ...
    {: .note } Feel free to proceed with saving to the machine.
...
1. Select **Export**.
    ...
    {: .important } The SOC Analyst could then export the CSV results of the three KQL queries they executed, and attach the evidence files to the incident record.  
...
1. At the top of the flyout pane, select **Manage incident** and verify all the details are filled in. 
    ...
    {: .note } This is filled out by the Security Architecture team in their task.
