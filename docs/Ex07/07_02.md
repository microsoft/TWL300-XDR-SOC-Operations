...
1. Select **Create**.
    ...
    {: .important } Policies may take 5-10 minutes to propagate.
...
1. On the **Identity Protection** page's menu, under **Report**, select **Risky sign-ins**.
    ...
    {: .important } if any risky users or sign-ins are found, confirm the **Risk state** column shows access was **Blocked** or **Remediation required**.
