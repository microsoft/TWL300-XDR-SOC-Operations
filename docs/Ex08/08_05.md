...
1. Save the query: 
    ...
    {: .important } You can do something to automate this through the Advanced Hunting API to query daily at 09:00am, then export a CSV to a location, like *SOC/Hunting/Daily*.
    >
